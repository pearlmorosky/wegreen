$(document).ready(function(){
  var quoteSource=[
  {
    ...
    {
      quote:"Only have ceiling fan on while you are in the room. It doesn’t actually change the temperature of the room, just makes people in the room more comfortable",
      name:"we green"
    },
    {
    ...
    {
      quote:"Buy in bulk when possible, and use reusable packaging. For example, reuse plastic containers and bags or use glass jars",
      name:"we green"
    },
    {
    ...
    {
      quote:"Try to buy local, as buying local not only supports the community but also helps cut down on emissions produced in transportation",
      name:"we green"
    },
    {
      quote:"Try to buy used products (like thrift shopping) when possible, as used products cut down on the “provision of goods”, which refers to all the resources which are used to produce new goods",
      name:"we green"
    },
    {
    ...
    {
      quote:"Use air conditioning and heating as sparingly as possible. While the use of A/C and heating is unavoidable, keeping your house a few degrees warmer in the summer and a few degrees cooler in the winter can save a great amount of energy or fuel",
      name:"we green"
    },
    {
    ...
    {
      quote:"Turn down the hot water in the shower. While it is not realistic for everyone to take cold showers, taking a lukewarm shower instead of a steaming hot one can save a lot of energy",
      name:"we green"
    },
    {
    ...
    {
      quote:"Do research into the Austin recycling system to get to know what you can and can’t recycle, and make sure you are always recycling when possible",
      name:"we green"
    },
    {
      quote:"Do research into the Austin composting system to get to know what you can and can’t compost, and make sure you are always composting when possible",
      name:"we green"
    },
    {
